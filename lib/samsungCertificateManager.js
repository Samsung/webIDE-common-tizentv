...
module.exports = class SamsungCM {
    ...
    */
    createAuthorCert(profileName, authorInfo, accessInfo) {
        console.info('[webide-common-tizentv]SamsungCM.createAuthorCert(): start...');
        ...
        this.fetchAuthorCRT(accessInfo).then((message) => {
            if (message == 'success') {
                ...
                console.info('[webide-common-tizentv]SamsungCM.createAuthorCert(): fetchCRT failed.');
            }
    ...
    */
    createDistributorCert(profileName, distrbutorInfo, accessInfo) {
        console.info('[webide-common-tizentv]SamsungCM.createDistributorCert(): start...');
        ...
        this.fetchDistributorCRT('fetch_xml').then(this.fetchDistributorCRT.bind(this)).then((message) => {
            ...
            console.info('[webide-common-tizentv]SamsungCM.createDistributorCert(): fetchCRT failed. message:' + message);
            deferred.resolve(message);
        });

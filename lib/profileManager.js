    ...
    */
    registerProfile(profileName, authorProfile, distributorProfile) {
        ...
        if (authorProfile.authorPassword != '') {
            ...
            cryptUtil.encryptPassword(authorProfile.authorPassword, authorPwdFile);
        }
        ...
        if (distributorProfile.distributorPassword != '') {
            ...
            if (!fs.existsSync(distributorPwdFile)) {
                cryptUtil.encryptPassword(distributorProfile.distributorPassword, distributorPwdFile);
            }
        }
